...
export const INDIA_LOCATION_DATA: Record<string, string[]> = {
  ...
  'Maharashtra': [
    'Ahmednagar', 'Akola', 'Amravati', 'Chhatrapati Sambhajinagar', 'Bhandara', 
    'Beed', 'Buldhana', 'Chandrapur', 'Dhule', 'Gadchiroli', 'Gondia', 'Hingoli', 
...
export const ALL_INDIAN_STATES_AND_UTS = Object.keys(INDIA_LOCATION_DATA);

export function getDistrictsForState(stateName: string): string[] {
  return INDIA_LOCATION_DATA[stateName] || [];
}
